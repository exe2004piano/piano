$(document).ready(function() {
	...
	$('.b-catList__link').click(function(e){
		if( $(this).hasClass('active')){
			$(this).siblings('.b-catList__sub').slideUp();
			$(this).removeClass('active');
			e.preventDefault();
		} else {
			$('.b-catList__sub').slideUp();
			$('.b-catList__link').removeClass('active');
			$(this).addClass('active');
			$(this).siblings('.b-catList__sub').slideDown();
			e.preventDefault();
		};
	});
	...
	// $('.b-footer__title').click(function(){
	...
	$('.b-delivery__title').click(function(e){
		if ($(this).hasClass('active')){
			$(this).removeClass('active');
			$(this).siblings('.b-delivery__productList').slideUp();
			e.preventDefault();
		} else {
			$(this).addClass('active');
			$(this).siblings('.b-delivery__productList').slideDown();
			e.preventDefault();
		};
	});
	...
	var $linkInSub = $('.js-menu').find('.submenu_in'),
		...
		back = '<div class="b-header__submenu-itemt class="b-header__submenu-itemt--back"><a href="#" class="b-header__submenu-link b-header__submenu-link--back">Скрыть</a></div>'
	...
	$(document).click(function(e) {
		if($(e.target).closest(".js-menuButton").length ==0 &&
