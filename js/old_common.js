...
$(document).ready(function () {
    ...
    {
        setTimeout(function(){$("#thanks_btn").trigger("click");}, 2000);
    }
  ...
  $('#gallery .card__img').click(function (event) {
    ...
    var $pswp = $('.pswp')[0],
      options = {
        index: $(this).parent('.card-list__item').index(),
        bgOpacity: 0.85,
  ...
  $(document).on("click", "[data-tab]", function (e) {
    ...
    parents.find(".b-tab__content.active .slick-carousel .slick-list").css("width", "100%");
    parents.find(".b-tab__content.active .slick-carousel .list__item").removeAttr("style");
    parents.find(".b-tab__content.active .slick-carousel").slick('setPosition').slick();;
  })
