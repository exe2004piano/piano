...
$promo_text =
    '
                                    <h3 class="b-main__orderInto-title2">Еще дешевле!</h3>
                                    <form action="" method="post" class="form-promo">
                                        ...
                                        <!--promo_info-->
                                        <button type="submit" class="bv-btn bv-btn--third"><span class="bv-btn__text">Проверить</span></button>
                                    </form>
    ';
...
// --- если промокод еще не был зафиксирован, но передан нам в пост-запросе:
    if( (isset($_SESSION['promocode']) && $_SESSION['promocode']!='') || (isset($_POST['promocode'])) )
    {
...
// --- получим массив ID => kolvo
    ...
    ";
		...
		console.log('gtag_begin_checkout');
		";

		$google_gp_2 = " function onCheckout() {console.log('onCheckout');} ";
		$doc->addScriptDeclaration(" document.addEventListener('DOMContentLoaded', function() { fbq('track','AddToCart'); console.log('fbq - addtocart');}); {$google_gp_1} {$google_gp_2} ");
            ...
            '<div class="b-basket__order">
                <div class="b-main__orderInto">
                    ...
                    <div class="b-main__orderInto-table" >
                        ...
                        <a href="/basket-step2" onclick="onCheckout();" class="bv-btn bv-btn--third" ><span class="bv-btn__text">ОФОРМИТЬ ЗАКАЗ</span></a>
                        '.$promo_text.'
                </div>
            </div>';
