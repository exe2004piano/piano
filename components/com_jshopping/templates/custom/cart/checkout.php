...
<table class = "jshop cart">
  ...
  <tr class = "jshop_prod_cart <?php if ($i%2==0) print "even"; else print "odd"?>">
    ...
    <td>
      <?php
		$calc_price = str_replace('USD', '',formatprice($prod['price']*$prod['quantity']))*$currency->currency_value.' '.$currency->currency_code;
        echo $calc_price;
  ...
  <tr class="total">
    ...
    <td class = "value">
      <?php
  		$calc_price = str_replace('USD', '',formatprice($this->fullsumm))*$currency->currency_value.' '.$currency->currency_code;
        echo $calc_price;
      //print formatprice($this->fullsumm)
