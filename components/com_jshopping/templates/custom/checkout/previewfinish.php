   ...
   <table class = "jshop" align="center" style="width:auto;margin-left:auto;margin-right:auto;">
     ...
     <tr>
       <td style="text-align:center;padding-top:3px;">
		   <input class="button next" type="submit" name="finish_registration" value="<?php print _JSHOP_ORDER_FINISH?>" <?php if ($this->config->display_agb){?>onclick="return checkAGB()"<?php }?> />
       </td>
     </tr>
   </table>
