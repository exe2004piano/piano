...
<script type="text/javascript">
    (window["rrApiOnReady"] = window["rrApiOnReady"] || []).push(function() {
        try{ rrApi.view(<?php echo $product->product_id; ?>); }  catch(e) {}
    })
</script>

<div itemscope itemtype="http://schema.org/Product">
<div class="b-section__title b-section__title--bigtype2">
    ...
    <div class="b-itemImg">
        ...
        <div class="b-itemImg__imgWrap">
            ...
            <div class="b-itemImg__imgMain">
                <a href="/components/com_jshopping/files/img_products/full_<?php echo $product->image;?>" class="b-itemImg__imgMain-link fancybox" rel="group">
                    <img itemprop="image" src="/components/com_jshopping/files/img_products/full_<?php echo $product->image;?>" alt="">
                </a>
        ...
        <?php
        /*
        <div class="b-item__action">
            <div class="b-item__actionTitle">АКЦИЯ</div>
            <div class="b-item__actionImg">
                <img src="assets/i/product/product_3.jpg" alt="">
            </div>
            <div class="b-item__actionText">
                <h3 class="b-item__actionText-title">В подарок!</h3>
                <span class="b-item__actionText-name">Полноразмерные наушники Sennheiser HD180</span>
                <a href="#" class="b-item__actionText-link">Подробнее об акции</a>
            </div>
            <div class="b-item__actionTime">
                <div class="b-item__actionTime-title">до конца акции осталось:</div>
                <div id="clock" data-time="2000"></div>
            </div>
        </div>
        */
        ?>
...
<div class="b-option__lineTitle">
    <ul class="b-filter__currency">
        <li class="b-filter__currencyIyem">
            <a href="#" class="b-filter__currencyLink <?php echo $actve[1];?>" data-tab="1" onclick="set_currency_(1); return true;">BYN</a>
        </li>
        <li class="b-filter__currencyIyem">
            <a href="#" class="b-filter__currencyLink <?php echo $actve[2];?>" data-tab="2" onclick="set_currency_(2); return true;">USD</a>
        </li>
        <li class="b-filter__currencyIyem">
            <a href="#" class="b-filter__currencyLink <?php echo $actve[3];?>" data-tab="3" onclick="set_currency_(3); return true;">RUR</a>
        </li>
    </ul>
    ...
    <ul class="b-option__list">
        <li class="b-option__item">
            <a href="#" class="b-option__link b-option__link--like" onclick="add_to_like('<?php echo $product->product_id;?>'); return false;"></a>
        </li>
        <li class="b-option__item">
            <a href="#" class="b-option__link b-option__link--compare" onclick="add_to_compare('<?php echo $product->product_id;?>'); return false;"></a>
        ...
        <li class="b-option__item js_listWrap">
            ...
            <ul class="b-option__linkList js_listBlock">
                <li class="b-option__linkItem">
                    <a href="#price_lower" class="b-option__linkLink" onclick="$('#product_price_lower').val('<?php echo $product->name;?>');">Сообщить о снижении цены</a>
                </li>
                <li class="b-option__linkItem">
            ...
            <nav class="b-nav__menu">
                <div class="b-nav__header">
                    ...
                    <div class="b-nav__links">
                        <a href="#" class="b-slider__optionBasket" onclick="event_send('Korzina_Dobavit', 'DobavitVkorzina'); add_to_basket('<?php echo $cur_id;?>', 1); return false;">в корзину</a>
                        <button data-remodal-target="oneClick" class="b-slider__oneClick" style="display: none;"
                                onclick="event_send('Kupit_v_1klik1', 'Kupitv1klik1'); $('#product_one_click').val('<?php echo str_replace(Array("'", '"'), " ", $product->name); ?>'); $('#product_one_click_id').val('<?php echo $cur_id; ?>'); $('#product_one_click_price').val('<?php echo $this->product->product_price; ?>'); "
                            >Купить в 1 клик</button>
                        <a href="#" class="b-slider__optionLike" onclick="add_to_like('<?php echo $cur_id;?>'); return false;"></a>
                        <a href="#" class="b-slider__optionCompare" onclick="add_to_compare('<?php echo $cur_id;?>'); return false;"></a>
                    </div>
                </div>
                <ul class="b-nav__menu-list">
                    ...
                    <?php if(trim($product->tab_2)!='') { ?>
                        <li class="b-nav__menu-item">
                            <a href="#characteristics_block" class="b-nav__menu-link js-anchor characteristics_block"> <span>Характеристики</span></a>
                        </li>
                    <?php } ?>
            ...
            <nav class="b-nav__option">
                <ul class="b-header__optionList">
                    <li class="b-header__optionItem">
                        <a href="/#" class="b-header__optionLink b-header__optionLink--compare" data-num="0" id="compare_b" onclick="if(this.href=='https://piano.by/#') return false;">
                            <span class="b-header__optionLink-num" id="compare_span_b">0</span>
                        </a>
                    </li>
                    <li class="b-header__optionItem">
                        <a href="/#" class="b-header__optionLink b-header__optionLink--like" data-num="0" id="like_b" onclick="if(this.href=='https://piano.by/#') return false;">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                */
                ...
                <div data-retailrocket-markup-block="5d3aded997a5281eb44a58aa" data-product-id="<?=$this->product->product_id;?>"></div>
