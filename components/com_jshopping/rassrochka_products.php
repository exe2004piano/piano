...
$db->setQuery("SELECT * FROM #__z_config WHERE id=29");     // name='rassrochka'
$c = $db->loadObject();
...
$this->document->setTitle('Товары с рассрочкой в лучшем музыкальном магазине Беларуси - Piano.by!');
