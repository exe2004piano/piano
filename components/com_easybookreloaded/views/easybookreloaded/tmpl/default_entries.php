...
<div class="easy_entries">
    <?php foreach($this->entries as $entry) : ?>
        <div class="easy_frame" <?php if(!$entry->published) : ?>style="background-color: #fffefd; border: #ffb39b solid 1px;"<?php endif; ?>>
            ...
            <?php endif; ?>
            <div class="easy_content"><span class="left_quote"><img src="/components/com_easybookreloaded/images/quote_left.png"></span><span><?php echo EasybookReloadedHelperContent::parse($entry->gbtext) ?></span><span class="right_quote"><img src="/components/com_easybookreloaded/images/quote_right.png"></span></div>
            <div class="easy_top_left">
                    <i class="easy_small"> Дата размещения: 
                    ...
                    <i class="easy_big" id="gbentry_<?php echo $entry->id; ?>">Размещено: <?php echo $entry->gbname ?></i>
                </div>
