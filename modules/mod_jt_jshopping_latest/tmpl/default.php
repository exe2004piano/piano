...
<style>
#jt_jshopping_lates_slider ul li { background: none;  width:'.$jt_width.'px; height:'.$jt_height.'px;}
#jt_jshopping_lates_slider .jt_button_prev_'.$jt_id_sfx.' a, #jt_jshopping_lates_slider .jt_button_next_'.$jt_id_sfx.' a {height:'.$jt_height.'px;}
</style>');	
...
if ($jt_load_jquery == 2) { ?>
	...
	<script type = "text/javascript" src = "<?php echo JURI::root() ?>/modules/mod_jt_jshopping_latest/js/jquery.bxSlider.min.js"></script>
	<?php } ?>
...
jQuery(document).ready(function(){
	jQuery('#lates_slider<?php if ($jt_id_sfx !='') echo $jt_id_sfx; ?>').bxSlider({
	prevSelector:'.jt_button_prev_<?php echo $jt_id_sfx;?>',
	nextSelector:'.jt_button_next_<?php echo $jt_id_sfx;?>',
...
<div class="mod_jt_jshopping_latest <?php echo $moduleclass_sfx;?>">
	<div id="jt_jshopping_lates_slider">
		<div class="jt_button_prev_<?php echo $jt_id_sfx;?> jt_prev<?php echo $jt_vertical;?>"></div>
		<ul id="lates_slider<?php if ($jt_id_sfx !='') echo $jt_id_sfx; ?>">
			   ...
			   <div class="block_item">
				   ...
				   <?php if ($show_image) { ?>
					<div class="item_image">
						...
						<?php }?>
						<span>
							<a href="<?php print $curr->product_link?>"><img src = "<?php print $jshopConfig->image_product_live_path?>/<?php if ($curr->product_thumb_image) print $curr->product_name_image; else print $noimage?>" alt="<?php print $curr->name?>" />
...
$calc_old_price = 	str_replace('$', '',formatprice($curr->product_old_price))*$currency->currency_value.' '.$currency->currency_code; if (formatprice($curr->product_old_price) > 0){?>
		...
		<div class="jt_button_next_<?php echo $jt_id_sfx;?> jt_next<?php echo $jt_vertical;?>"></div>
	</div>
