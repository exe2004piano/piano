<?php
	...
	class JFormFieldWishBoxJShoppingProduct extends JFormField
	{
		...
		protected function getInput()
		{
			...
			// 
			$script->addTemplatePath(JPATH_SITE.'/modules/mod_jshopping_custom_products/admin/fields/wishboxjshoppingproduct/tmpl');
			// 
			...
			// 
			$html->addTemplatePath(JPATH_SITE.'/modules/mod_jshopping_custom_products/admin/fields/wishboxjshoppingproduct/tmpl');
			// 
			$html->setLayout('html');
			// 
			$html->field = $this;
