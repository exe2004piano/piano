<?php
	...
	class JFormFieldWishBoxJShoppingProduct extends JFormField
	{
		...
		protected function getInput()
		{
			...
			// 
			$script->addTemplatePath(JPATH_SITE.'/modules/mod_jshopping_latest_products/element/wishboxjshoppingproduct/tmpl');
			// 
			...
			// 
			$html->addTemplatePath(JPATH_SITE.'/modules/mod_jshopping_latest_products/element/wishboxjshoppingproduct/tmpl');
			// 
			$html->setLayout('html');
			// 
			$html->field = $this;
