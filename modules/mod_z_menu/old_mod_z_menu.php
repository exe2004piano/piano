...
$menu =  '<ul class="b-menu__list is--frontpage">';
foreach($cat1 AS $c1)
{
    ...
    $menu .='
        <li class="b-menu__item ">
            <a href="'.$link.'" class="b-menu__link submenu_in">'.$c1->$name_ru.'</a>';
    ...
    {
        $menu .='<div class="b-menu__subContent js-subMenu">
        ...
        foreach($cat2 AS $c2)
        {
            ...
            $menu .= '<div class="b-menu__subMenu-column"><a href="'.$link.'" class="b-menu__subMenu-title">'.$c2->$name_ru.'</a>';
