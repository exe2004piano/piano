...
class http {
        ...
        public function get($url, $encoding=null) {
                $this->init($url);
                curl_setopt($this->ch, CURLOPT_HTTPHEADER, array ("Content-Type: application/xml", "Content-Length: 0"));
                $this->setDefaults();
                $this->exec();
        ...
        */
        private function setPostFields($postdata) {
                ...
                curl_setopt($this->ch, CURLOPT_HTTPHEADER, array ("Content-Type: application/xml", "Content-Length:" . strlen($postdata)));
        }
